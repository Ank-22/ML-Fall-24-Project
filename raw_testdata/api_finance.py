...
for tick in ["^CNXIT", "^NSEI", "INFY.NS", "LTIM.NS", "PERSISTENT.NS", "TCS.NS", 'WIPRO.NS', 'HCLTECH.NS' ]:
    print("Starting Ticker:  " + tick)
    ticker = tick
    start_date = "2024-11-29"  # Start date for data collection
    end_date = "2024-12-8"    # End date for data collection
    ...
    if data_frames:
        ...
        output_filename = f"Test_{ticker}_30_days_data_1m.csv"
